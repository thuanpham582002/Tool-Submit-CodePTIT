...
function addItem() {
	...
	let listItem = document.getElementById("itemListSelect");
	let strRegEx = document.getElementById("urlInput").value;
...
function testRegEx() {
	...
	let strRegEx = document.getElementById("urlInput").value;
	let url = document.getElementById("testURLInput").value;
...
document.getElementById('itemListSelect').addEventListener('dblclick', onItemSelected);
document.getElementById('itemListSelect').addEventListener('click', onClick);
document.getElementById("urlInput").addEventListener('keyup', changeItem);
document.getElementById("testURLInput").addEventListener('keyup', testRegEx);
document.getElementById("urlInput").focus();
